...
async ({ prompt, output_directory, file_name, input_image_paths, use_enhanced_prompt }) => { // use_enhanced_prompt を追加
  let res = await generateImageTool.execute({ prompt, output_directory, file_name, input_image_paths, use_enhanced_prompt }) // use_enhanced_prompt を渡す
  return {
