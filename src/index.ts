...
async ({ prompt, output_directory, file_name, input_image_paths }) => { // mime_type, aspect_ratio を削除
  let res = await generateImageTool.execute({ prompt, output_directory, file_name, input_image_paths }) // mime_type, aspect_ratio を削除
  return {
